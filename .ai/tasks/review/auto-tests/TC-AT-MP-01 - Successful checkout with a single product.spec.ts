...
test('MP-01 - Successful checkout with a single product @regression @critical @smoke', async ({ page }) => {
  // Arrange
  ...
  await checkoutInfoPage.fillInformation({ firstName: FIRST_NAME, lastName: LAST_NAME, postalCode: POSTAL_CODE });
